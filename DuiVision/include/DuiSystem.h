...
//日志信息等级
#define DUIV_LOG_LEVELDEBUG 0x0001      //调试信息
#define DUIV_LOG_LEVELINFO	0x0002      //一般信息
#define DUIV_LOG_LEVELERROR 0x0004      //错误信息
#define DUIV_LOG_LEVELCRITICAL 0x0008	//致命信息
...
public:
    ...
    DuiSystem(HINSTANCE hInst,DWORD dwLangID, CString strLogFile,  CString strResourceFile = _T(""), UINT uAppID = 0, UINT nIDTemplate = 0, CString strStyle = _T(""));
    ~DuiSystem(void);
